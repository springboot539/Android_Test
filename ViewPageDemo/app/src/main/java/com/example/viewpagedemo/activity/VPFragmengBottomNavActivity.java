 ...
 * [类的说明]
 */
public class VPFragmengBottomNavActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable @org.jetbrains.annotations.Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vp_bottomnav_fragment);
        ...
        mVp.addOnPageChangeListener(new ViewPager.OnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                Toast.makeText(VPFragmengBottomNavActivity.this, "第" + position + "页", Toast.LENGTH_SHORT).show();
